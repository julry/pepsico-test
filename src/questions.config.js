...
export const questions = [
    {
        ...
        answers: [
            ...
            {
                id: '2',
                text: 'Постараюсь найти его\nконтакты, свяжусь с ним по личному телефону.\nМожет, он потерял свой\nрабочий телефон?',
    ...
    },
    {
        ...
        text: 'Листая ленту с утра, ты увидел,\nчто конкурент Lay’s запустил линейку новых вкусов, приуроченных к 14 февраля.\nЧто делать с этой информацией?',
        answers: [
            {
                id: '1',
            ...
            {
                id: '2',
                text: 'Детально изучить сезонную линейку конкурента \n' +
                    'и прийти к руководителю \n' +
                    'с проработанным предложением по интеграции схожих идей для линейки Lay’s',
    ...
    },
    {
        ...
        answers: [
            {
                id: '1',
                text: 'Соберу со всех отделов сначала мнения по отдельности, \n' +
                    'а затем приглашу всех \n' +
                    'на общий звонок и представлю проанализированные аргументы',
    ...
    },
    {
        ...
        text: 'Маркетинговая поддержка — важная часть электронных продаж. Например, в прошлом году PepsiCo создал активацию совместно с Яндекс.Лавкой. \n' +
    ...
    },
    {
        ...
        rotation: ROTATION_TYPES.electronicCommerce,
        text: 'Тебе поручили проанализировать конкурентов компании в е-коме и их активации в высокие сезоны, например, в Черную пятницу. Но ты не понимаешь, откуда брать информацию. Что будем делать?',
        answers: [
            {
                id: '1',
    ...
    },
    {
        ...
        text: 'Вы с коллегами провели первичную аналитику продаж по клиентам, каналам \n' +
            'и регионам. Вы увидели, что продажи резко растут летом, \n' +
            'в “сезон окрошки”, но больше никаких закономерностей \n' +
            'не нашли. Что делать?',
        answers: [
            {
                id: '1',
    ...
    },
    {
        ...
        answers: [
            {
                id: '1',
                text: 'Предложу найти агенство, которое проведет исследование  рынка и будет экспертно управлять проектом — потратим больше средств, \n' +
                    'но точно достигнем качественного результата',
                competence: [COMPETENCE_TYPES.results]
            },
            {
                id: '2',
    ...
    },
    {
        ...
        answers: [
            ...
            {
                id: '2',
                text: 'Обращусь к другим\nисточникам — наверняка в компании много данных, не беда!',
                competence: [COMPETENCE_TYPES.flexibility]
            },
            {
                id: '3',
    ...
    },
    {
        ...
        answers: [
            ...
            {
                id: '3',
                text: 'Пойду в sales-команду \n' +
                    'с предложением, как пересмотреть их KPI: \n' +
                    'мне важно достичь не только своих целей, но и чтобы другие коллеги не пострадали',
    ...
    },
    {
        ...
        answers: [
            ...
            {
                id: '3',
                text: 'Более подробно изучу всю накопленную в компании аналитику по региону, пообщаюсь с торговыми представителями. Если проблема есть уже сейчас, то нужно разобраться в ее первопричинах',
                competence: [COMPETENCE_TYPES.education]
            },
        ],
    },
